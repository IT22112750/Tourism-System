...
const Bookings = () => {
    ...
    return (
        <div className="my-4 p-3">
            <h2 className="m-0 text-center mb-4">Summary of Bookings</h2>
        ...
        <tr key={booking._id}>
            ...
            <td>
                ...
                <BsPencilSquare className="me-2" onClick={() => handleUpdate(booking._id)} />
                <BsTrash onClick={() => handleDelete(booking._id)} />
            </td>
        </tr>
    ))}
                </tbody>
